...
description: Investigating a reported bug or unexpected error — project-specific triage steps, not generic debugging advice.
---
...
5. Suspected tenant leak → run the two-workspace cross-check immediately (`tenant-isolation-review` skill), don't reason about it abstractly.
