...
description: Adding or changing a table, column, index, or RLS policy in packages/db.
---
...
**Good result looks like:** generated SQL was actually read before applying, and a real duplicate-insert/race was exercised if the table can race.
